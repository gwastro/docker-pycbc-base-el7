...
if ( x"${SINGULARITY_CONTAINER}" == "x" ) then 
    ...
    if ( "x${LD_LIBRARY_PATH}" == "x" ) then
        setenv LD_LIBRARY_PATH /opt/intel/composer_xe_2015.0.090/compiler/lib/intel64
    else
        setenv LD_LIBRARY_PATH /opt/intel/composer_xe_2015.0.090/compiler/lib/intel64:${LD_LIBRARY_PATH}
    endif
endif
